...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        <div class="fixed top-0 left-0 px-6 py-4 sm:block w-10">
            <img src="/img/TIRA DE LOGOS.png" class="h-10 w-10" alt="" srcset="" width="400px">
        </div>
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
            <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Cuestionario</a>
            @else
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <h3 class>Estimado (a) alumno (a) de quinto semestre de bachillerato:</h3>
                            </div>
                        </div>
