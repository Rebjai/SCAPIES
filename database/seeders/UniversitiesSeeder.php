...
class UniversitiesSeeder extends Seeder
{
    ...
    public function run()
    {
        Universidad::create( [
            ...
            Universidad::create( [
            'siglas'=>'IESCO-REUS',
            'nombre'=>'INSTITUTO DE ESTUDIOS SUPERIORES DE LA COSTA- REUS',
            'regimen_id'=>2
            ] );
            ...
            Universidad::create( [
            'siglas'=>'IESPINA-REUS',
            'nombre'=>'INSTITUTO DE ESTUDIOS SUPERIORES DE PINOTEPA NACIONAL -REUS',
            'regimen_id'=>2
            ] );
            ...
            Universidad::create( [
            'siglas'=>'IESPE-REUS',
            'nombre'=>'INSTITUTO DE ESTUDIOS SUPERIORES DE PUERTO ESCONDIDO -REUS',
            'regimen_id'=>2
            ] );
            ...
            Universidad::create( [
            'siglas'=>'IESTLAX-REUS',
            'nombre'=>'INSTITUTO DE ESTUDIOS SUPERIORES DE TLAXIACO -REUS',
            'regimen_id'=>2
            ] );
            ...
            Universidad::create( [
            'siglas'=>'IESPA-REUS',
            'nombre'=>'INSTITUTO DE ESTUDIOS SUPERIORES DEL PAPALOAPAN -REUS',
            'regimen_id'=>2
            ] );
